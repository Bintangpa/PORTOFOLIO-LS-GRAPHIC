...
<?php $__env->startSection('title', 'Edit Portofolio - Admin'); ?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-edit"></i> Edit Portofolio: <?php echo e($portfolio->title); ?>

            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.portfolios.update', $portfolio)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="title" name="title" value="<?php echo e(old('title', $portfolio->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Jelaskan detail tentang project ini..." required><?php echo e(old('description', $portfolio->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <option value="LOGO DESIGN" <?php echo e((old('category_select') ?? $portfolio->category) == 'LOGO DESIGN' ? 'selected' : ''); ?>>LOGO DESIGN</option>
                                            <option value="POSTER DESIGN" <?php echo e((old('category_select') ?? $portfolio->category) == 'POSTER DESIGN' ? 'selected' : ''); ?>>POSTER DESIGN</option>
                                            <option value="COMMISSION DESIGN" <?php echo e((old('category_select') ?? $portfolio->category) == 'COMMISSION DESIGN' ? 'selected' : ''); ?>>COMMISSION DESIGN</option>
                                            <option value="PERSONAL USE DESIGN" <?php echo e((old('category_select') ?? $portfolio->category) == 'PERSONAL USE DESIGN' ? 'selected' : ''); ?>>PERSONAL USE DESIGN</option>
                                            <option value="LAINNYA" <?php echo e(!in_array((old('category_select') ?? $portfolio->category), ['LOGO DESIGN', 'POSTER DESIGN', 'COMMISSION DESIGN', 'PERSONAL USE DESIGN']) && !empty($portfolio->category) ? 'selected' : ''); ?>>LAINNYA</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                                                   ...
                                                   value="<?php echo e(!in_array($portfolio->category, ['LOGO DESIGN', 'POSTER DESIGN', 'COMMISSION DESIGN', 'PERSONAL USE DESIGN']) ? $portfolio->category : ''); ?>" 
                                                   placeholder="Masukkan kategori custom...">
                                        </div>
                                        
                                        <!-- Hidden input to store final category value -->
                                        <input type="hidden" id="category" name="category" value="<?php echo e(old('category', $portfolio->category)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                               id="client" name="client" value="<?php echo e(old('client', $portfolio->client)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('project_date', $portfolio->project_date ? $portfolio->project_date->format('Y-m-d') : '')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="current-image">
                                    <img src="<?php echo e(asset('storage/' . $portfolio->image_path)); ?>" 
                                         class="preview-image" id="currentImage" alt="<?php echo e($portfolio->title); ?>">
                                </div>
                                
                                <label for="image" class="change-image-label mt-3">
                                    <i class="fas fa-camera"></i> Ganti Gambar
                                </label>
                                <input type="file" class="form-control d-none <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('admin.portfolios.index')); ?>" class="btn btn-secondary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\littlestar-std\resources\views/admin/portfolios/edit.blade.php ENDPATH**/ ?>