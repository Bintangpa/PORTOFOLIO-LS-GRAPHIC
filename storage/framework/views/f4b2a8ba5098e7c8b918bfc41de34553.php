<nav class="navbar navbar-expand-lg navbar-light sticky-top">
    <div class="container-fluid px-4">
        <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('home')); ?>" style="height: 75px; margin-left: -8px;">
            <img src="<?php echo e(asset('images/logo-ls-biru.png')); ?>" alt="<?php echo e(\App\Models\WebsiteSetting::getValue('site_name', 'LittleStar Studio')); ?>" class="me-2" style="height: 85px; width: auto; position: relative; z-index: 10;"> <?php echo e(\App\Models\WebsiteSetting::getValue('site_name', 'LittleStar Studio')); ?>
