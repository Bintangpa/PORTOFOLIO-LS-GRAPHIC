<?php $__env->startSection('title', 'Kelola Halaman Tentang - Admin'); ?>
<?php $__env->startSection('page-title', 'Kelola Halaman Tentang'); ?>
...
<form action="<?php echo e(route('admin.about.update')); ?>" method="POST" id="aboutForm">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_hero_title]" class="form-control" 
                           value="<?php echo e($settings['about_hero_title']); ?>" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea name="settings[about_hero_description]" class="form-textarea" rows="4" required><?php echo e($settings['about_hero_description']); ?></textarea>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_vision_title]" class="form-control" 
                           value="<?php echo e($settings['about_vision_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Konten Visi</label>
                    <textarea name="settings[about_vision_content]" class="form-textarea" rows="4" required><?php echo e($settings['about_vision_content']); ?></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_mission_title]" class="form-control" 
                           value="<?php echo e($settings['about_mission_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Konten Misi</label>
                    <textarea name="settings[about_mission_content]" class="form-textarea" rows="4" required><?php echo e($settings['about_mission_content']); ?></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="settings[about_values_title]" class="form-control" 
                   value="<?php echo e($settings['about_values_title']); ?>" required>
        </div>
            ...
            <div class="value-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_value1_title]" class="form-control" 
                           value="<?php echo e($settings['about_value1_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_value1_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_value1_content']); ?></textarea>
                </div>
            </div>
            ...
            <div class="value-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_value2_title]" class="form-control" 
                           value="<?php echo e($settings['about_value2_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_value2_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_value2_content']); ?></textarea>
                </div>
            </div>
            ...
            <div class="value-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_value3_title]" class="form-control" 
                           value="<?php echo e($settings['about_value3_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_value3_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_value3_content']); ?></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="settings[about_services_title]" class="form-control" 
                   value="<?php echo e($settings['about_services_title']); ?>" required>
        </div>
            ...
            <div class="service-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_service1_title]" class="form-control" 
                           value="<?php echo e($settings['about_service1_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_service1_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_service1_content']); ?></textarea>
                </div>
            </div>
            ...
            <div class="service-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_service2_title]" class="form-control" 
                           value="<?php echo e($settings['about_service2_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_service2_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_service2_content']); ?></textarea>
                </div>
            </div>
            ...
            <div class="service-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_service3_title]" class="form-control" 
                           value="<?php echo e($settings['about_service3_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_service3_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_service3_content']); ?></textarea>
                </div>
            </div>
            ...
            <div class="service-item">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_service4_title]" class="form-control" 
                           value="<?php echo e($settings['about_service4_title']); ?>" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="settings[about_service4_content]" class="form-textarea" rows="3" required><?php echo e($settings['about_service4_content']); ?></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_cta_title]" class="form-control" 
                           value="<?php echo e($settings['about_cta_title']); ?>" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="form-label">Deskripsi CTA</label>
                    <textarea name="settings[about_cta_description]" class="form-textarea" rows="3" required><?php echo e($settings['about_cta_description']); ?></textarea>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_cta_button_text]" class="form-control" 
                           value="<?php echo e($settings['about_cta_button_text']); ?>" required>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="save-section">
        ...
        <div class="d-flex justify-content-center flex-wrap">
            <a href="<?php echo e(route('about')); ?>" target="_blank" class="btn btn-preview">
