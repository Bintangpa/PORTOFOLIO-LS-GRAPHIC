<?php $__env->startSection('title', 'Kontak Control - Admin'); ?>
<?php $__env->startSection('page-title', 'Kontak Control'); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[company_tagline]" class="form-control" 
                                   value="<?php echo e($settings['company_tagline']); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[contact_whatsapp]" class="form-control" 
                                   value="<?php echo e($settings['contact_whatsapp']); ?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="settings[operating_hours]" class="form-control" rows="4" required><?php echo e($settings['operating_hours']); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\littlestar-std\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>