...
<div class="compact-form">
    <div class="card compact-card">
        <div class="card-body">
            <form id="portfolioForm" action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="mb-compact">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Jelaskan detail tentang project ini..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="action-buttons">
            <div class="d-flex justify-content-center align-items-center position-relative">
                <div class="position-absolute start-0">
                    <a href="{{ route('admin.portfolios.index') }}" class="btn btn-danger btn-action">
