...
@section('title', 'Portfolio Page Control - Admin')
@section('page-title', 'Portfolio Page Control')
...
<div class="container-fluid">
    ...
    <div class="preview-section">
        ...
        <div class="preview-header">
            <h1 id="previewHeader">{{ $settings['portfolio_header'] }}</h1>
            <p id="previewSubtitle">{{ $settings['portfolio_subtitle'] }}</p>
        </div>
        
        <!-- Search Preview -->
        <div class="preview-search">
            <div class="preview-search-form">
                <input type="text" placeholder="{{ $settings['portfolio_search_placeholder'] }}" id="previewSearchPlaceholder" readonly>
                <button class="preview-btn preview-btn-primary" id="previewSearchButton">{{ $settings['portfolio_search_button'] }}</button>
                <button class="preview-btn preview-btn-secondary" id="previewResetButton">{{ $settings['portfolio_reset_button'] }}</button>
            </div>
            <div class="preview-filter">
                <small class="text-muted me-2" id="previewFilterLabel">{{ $settings['portfolio_filter_label'] }}</small>
                <a href="#" class="preview-filter-btn active" id="previewFilterAll">{{ $settings['portfolio_filter_all'] }}</a>
    ...
    <div class="portfolio-control-container">
        <form action="{{ route('admin.portfolio-page.update') }}" method="POST" id="portfolioPageForm">
            @csrf
            @method('PUT')
            ...
            @if(config('app.debug'))
                <div class="alert alert-info">
                    <small><strong>Debug:</strong> Form akan dikirim ke: {{ route('admin.portfolio-page.update') }}</small>
                </div>
            @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_header]" class="form-control" 
                                   value="{{ $settings['portfolio_header'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="settings[portfolio_subtitle]" class="form-control" 
                                      rows="3" id="portfolioSubtitle" required>{{ $settings['portfolio_subtitle'] }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_search_placeholder]" class="form-control" 
                                   value="{{ $settings['portfolio_search_placeholder'] }}" 
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_search_button]" class="form-control" 
                                   value="{{ $settings['portfolio_search_button'] }}" 
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_reset_button]" class="form-control" 
                                   value="{{ $settings['portfolio_reset_button'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_filter_label]" class="form-control" 
                                   value="{{ $settings['portfolio_filter_label'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_filter_all]" class="form-control" 
                                   value="{{ $settings['portfolio_filter_all'] }}" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_search_results_for]" class="form-control" 
                                   value="{{ $settings['portfolio_search_results_for'] }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_search_category]" class="form-control" 
                                   value="{{ $settings['portfolio_search_category'] }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_search_results_found]" class="form-control" 
                                   value="{{ $settings['portfolio_search_results_found'] }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_no_results_title]" class="form-control" 
                                   value="{{ $settings['portfolio_no_results_title'] }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_no_results_message]" class="form-control" 
                                   value="{{ $settings['portfolio_no_results_message'] }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_no_results_link]" class="form-control" 
                                   value="{{ $settings['portfolio_no_results_link'] }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_empty_title]" class="form-control" 
                                   value="{{ $settings['portfolio_empty_title'] }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_empty_message]" class="form-control" 
                                   value="{{ $settings['portfolio_empty_message'] }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_pagination_showing]" class="form-control" 
                                   value="{{ $settings['portfolio_pagination_showing'] }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_pagination_of]" class="form-control" 
                                   value="{{ $settings['portfolio_pagination_of'] }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_pagination_portfolios]" class="form-control" 
                                   value="{{ $settings['portfolio_pagination_portfolios'] }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_social_title]" class="form-control" 
                                   value="{{ $settings['portfolio_social_title'] }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_social_subtitle]" class="form-control" 
                                   value="{{ $settings['portfolio_social_subtitle'] }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" 
                               ...
                               id="showSocial" 
                               {{ $settings['portfolio_show_social'] == '1' ? 'checked' : '' }}>
                    ...
                    <div class="social-media-item">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="settings[portfolio_social_instagram]" class="form-control" 
                                   value="{{ $settings['portfolio_social_instagram'] }}" 
                    ...
                    <div class="social-media-item">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="settings[portfolio_social_tiktok]" class="form-control" 
                                   value="{{ $settings['portfolio_social_tiktok'] }}" 
                    ...
                    <div class="social-media-item">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="settings[portfolio_social_whatsapp]" class="form-control" 
                                   value="{{ $settings['portfolio_social_whatsapp'] }}" 
                    ...
                    <div class="social-media-item">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="settings[portfolio_social_email]" class="form-control" 
                                   value="{{ $settings['portfolio_social_email'] }}" 
