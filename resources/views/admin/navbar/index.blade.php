...
@section('title', 'Navbar Control Panel - Admin')
@section('page-title', 'Navbar Control Panel')
...
<div class="container-fluid">
    ...
    <div class="preview-section">
        ...
        <div class="navbar-preview" id="navbarPreview">
            ...
            <div class="d-flex align-items-center me-4" id="brandSection">
                @if($settings['navbar_show_logo'] == '1')
                    <img src="{{ asset($settings['navbar_logo']) }}" 
                         alt="Logo" 
                         class="preview-logo me-2" 
                         id="previewLogo"
                         style="height: {{ $settings['navbar_logo_height'] }}px; width: {{ $settings['navbar_logo_width'] }};">
                @endif
                @if($settings['navbar_show_title'] == '1')
                    <span class="preview-title" id="previewTitle">{{ $settings['navbar_title'] }}</span>
                @endif
            </div>
            
            <!-- Menu Section -->
            <div class="d-flex align-items-center gap-3 flex-wrap" id="menuSection">
                <span class="badge bg-primary" id="previewMenuHome">{{ $settings['navbar_menu_home'] }}</span>
                <span class="badge bg-primary" id="previewMenuPortfolio">{{ $settings['navbar_menu_portfolio'] }}</span>
                <span class="badge bg-primary" id="previewMenuAbout">{{ $settings['navbar_menu_about'] }}</span>
                <span class="badge bg-primary" id="previewMenuContact">{{ $settings['navbar_menu_contact'] }}</span>
                <span class="badge bg-secondary" id="previewMenuDashboard">{{ $settings['navbar_menu_dashboard'] }}</span>
                <span class="badge bg-info text-dark" id="previewSearchPlaceholder">🔍 {{ $settings['navbar_search_placeholder'] }}</span>
            </div>
        </div>
    ...
    <div class="navbar-control-container">
        <form action="{{ route('admin.navbar.update') }}" method="POST" enctype="multipart/form-data" id="navbarForm">
            @csrf
            @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" 
                                       ...
                                       id="showTitle" 
                                       {{ $settings['navbar_show_title'] == '1' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_menu_home" class="form-control" 
                                   value="{{ $settings['navbar_menu_home'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_menu_portfolio" class="form-control" 
                                   value="{{ $settings['navbar_menu_portfolio'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_menu_about" class="form-control" 
                                   value="{{ $settings['navbar_menu_about'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_menu_contact" class="form-control" 
                                   value="{{ $settings['navbar_menu_contact'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_menu_dashboard" class="form-control" 
                                   value="{{ $settings['navbar_menu_dashboard'] }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="navbar_search_placeholder" class="form-control" 
                                   value="{{ $settings['navbar_search_placeholder'] }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" 
                                       ...
                                       id="showLogo" 
                                       {{ $settings['navbar_show_logo'] == '1' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="navbar_logo_width" class="form-control" 
                                           value="{{ $settings['navbar_logo_width'] }}" 
                                           id="logoWidth" 
                                           placeholder="auto">
