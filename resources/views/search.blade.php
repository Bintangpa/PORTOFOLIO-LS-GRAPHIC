            ...
            <div class="filter-sidebar">
                ...
                <div class="filter-content">
                    ...
                    <div class="contact-buttons">
                        <a href="https://wa.me/{{ \App\Models\WebsiteSetting::getValue('contact_whatsapp', '62123456789') }}" target="_blank" class="btn btn-success w-100 mb-2">
                            <i class="fab fa-whatsapp me-2"></i>WhatsApp
                        </a>
                        <a href="https://instagram.com/{{ \App\Models\WebsiteSetting::getValue('contact_instagram', 'littlestarstudio') }}" target="_blank" class="btn btn-instagram w-100 mb-2">
                            <i class="fab fa-instagram me-2"></i>Instagram
                        </a>
                        <a href="mailto:{{ \App\Models\WebsiteSetting::getValue('contact_email', 'info@littlestarstudio.com') }}" class="btn btn-email w-100">
                ...
                @if($portfolios->count() > 0)
                    <div class="portfolio-list">
                        @foreach($portfolios as $portfolio)
                            <div class="portfolio-list-item" data-portfolio-id="{{ $portfolio->id }}">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-header">
                                        <h6 class="portfolio-title mb-1">{{ $portfolio->title }}</h6>
                                        @if($portfolio->category)
                                            <span class="badge badge-category-small">{{ $portfolio->category }}</span>
                                        @endif
                                    </div>
